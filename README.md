...
## Introduction
This repository has taken definitions outlined in [Wikipedia's List of Go terms](https://en.wikipedia.org/wiki/List_of_Go_terms) and put them into a form which can be easily learnt/revised using <a href="https://apps.ankiweb.net/">Anki</a> a cross platform app specifically designed for long term knowledge retention.

## Notes
Please note the modifications which have been made & where you can find updates.
1. The front of every card has "(Wikipedia List of Go Terms)" appended to the end so that if you have any other words in your collection, the Wikipedia definition will still be added when importing it.
2. Any updates or corrections to the deck will be available at <a href="https://github.com/darigovresearch/Wikipedia-List-of-Go-Terms-Flashcards">https://github.com/darigovresearch/Wikipedia-List-of-Go-Terms-Flashcards</a> so do return periodically to check if you have the latest version.
...
2. To be able to automatically sort the cards so that the words which are used most in the list is displayed first for the user to learn.
...
To see this workhttps://github.com/darigovresearch/Wikipedia-List-of-Go-Terms-Flashcardss
